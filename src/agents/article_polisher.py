...
class ApolloArticlePolishingAgent(BaseAgent):
    """
    Agent responsible for article polishing. Refines and improves article content for better quality and readability.
    """
    ...
    def __init__(
        ...
        super().__init__(name="article_polisher", role="editor", lm=article_polish_lm)
        self.article_gen_lm = article_writer_lm
    ...
    def polish_article(
        self, topic: str, draft_article: Article, remove_duplicate: bool = False
    ) -> Article:
        """
        Polish article.
        ...
        Args:
            ...
            draft_article (ApolloArticle): The draft article.
